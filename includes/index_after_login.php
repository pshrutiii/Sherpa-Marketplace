            ...
            <div class="row">
                ...
                <div class="medium-3 small-12 columns account-wrap">
                    ...
                    <div class="my-account-holder cart-holder float-left">
                        ...
                        <div class="my-account-title" data-toggle="my-cart" aria-controls="my-cart" data-is-focus="false" data-yeti-box="my-cart" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="my-account-holder float-right">
                        ...
                        <div class="my-account-title" data-toggle="myaccount-dropdown" aria-controls="myaccount-dropdown" data-is-focus="false" data-yeti-box="myaccount-dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="links float-left">
                                <?php  extract($_POST); echo "Welcome,". $_POST['username']?>
                            </div>
                            <div class="clearfix"></div>
                        </div><!-- ends title /-->
                        <!-- Hidden Menus -->
