	    ...
	    <div class="product-meta">
	        ...
	        <div class="last-row">
	            <div class="pro-rating float-left">');
	             printf(' <input id="%s" type="hidden" class="rating rate" value="%s" data-readonly data-filled="fa fa-star fa-x" data-empty="fa fa-star-o fa-x" data-fractions="2"/>',$id[$i], 0); //TODO: uncomment -->//$avg_rating[$i]);
	            printf('</div>
